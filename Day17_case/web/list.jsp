    ...
    <div style="float: left;margin: 5px">
        <form class="form-inline" action="${pageContext.request.contextPath}/FindUserByPageServlet" method="post">
            <div class="form-group">
                ...
                <input type="text"  value="${condition.name[0]}" name="name" class="form-control" id="InputName">
            </div>
            <div class="form-group">
                <label for="InputAddress">籍贯</label>
                <input type="text" value="${condition.address[0]}"name="address" class="form-control" id="InputAddress">
            </div>
            <div class="form-group">
                <label for="InputEmail">邮箱</label>
                <input type="text"value="${condition.email[0]}" name="email" class="form-control" id="InputEmail">
            </div>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-default btn-sm"
                        ...
                        <a class="btn btn-default btn-sm"
                           href="javascript:delUser(${user.id})">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
